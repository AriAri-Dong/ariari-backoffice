...
public class TodayVisitTrendStrategy implements VisitTrendStrategy {
    ...
    public GetVisitTrendRes execute(LocalDate baseDate) {
        ...
        return GetVisitTrendRes.forHourlyData("hourly", baseDate, hourlyVisits);
    }
